...
createDataCenterWithServer = ->
    ...
    helper.getPBBuilder (pbBuilder) ->
        ...
        debug "about to create datacenter '#{dcName}' with one server " +
            "'#{serverName}'"
        pbBuilder
            .createDataCenter(
...
createDataCenterWithServerAndFirewallRulesContextSample = ->
    ...
    helper.getPBBuilder (pbBuilder) ->
        ...
        pbBuilder.createDataCenter(
            dataCenterName: dcName)
        pbBuilder.createServer(
            serverName: serverName
            cores: '1'
            ram: '256'
            lanId: 1,
